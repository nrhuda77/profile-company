...
<div class="card-body table-responsive">
    ...
    <h5 class="card-title">Selamat datang di recruitment Biru Arnawama Timur</h5>
    <p class="card-text text-dark">Silahkan isi form lamaran untuk melihat hasil di halaman ini.</p>
